class CriteriaUploadController < ApplicationController
  ...
  def add_provider
      if params[:filter].present?
        ...
        redirect_to edit_company_profile_path(id: @current_account.company.profile), notice: "Criterium added"
      end
  end
  ...
  def add_range(criterium, klass)
    ...
    klass.find_or_create_by(company_id: current_account.company_id,
